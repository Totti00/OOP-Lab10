...
public class AnotherConcurrentGUI extends JFrame {
    ...
    private static final long WAITINGTIME = 10_000L;
    ...
    public AnotherConcurrentGUI() {
        ...
        final Timer timer = new Timer(agent, WAITINGTIME);
    ...
    private final class Timer implements Runnable {
        ...
        private Timer(final Agent agent2, final long time) {
            this.time = time;
            this.agent2 = agent2;
        }
        @Override
        public void run() {
            try {
                ...
                SwingUtilities.invokeAndWait(() -> {
                    AnotherConcurrentGUI.this.setAllEnable();
                    this.agent2.stopCounting();
                });
            } catch (InvocationTargetException | InterruptedException ex) {
                ex.printStackTrace();
            }
